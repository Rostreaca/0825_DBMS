 ...
 *                 , 인덱스(INDEX), 패키지(PACKAGE), 트리거(TRIGGER), 프로시저(PROCEDURE), 함수(FUNCTION), 동의어(SYNONYM)...
 *  
 *  DQL : SELECT => 질의
...
INSERT INTO TB_USER_UNIQUE VALUES(NULL,'admin','1234',NULL,NULL);
 ...
 * => FOREIGN KEY 제약조건을 이용해서 다른 테이블간의 관계를 형성할 수 있다.
 * 
 * [ 표현법 ]
 * - 컬럼 레벨 방식
...
INSERT INTO TB_USER_CHILD VALUES(2, 'user02', 'user02', 'G2');
...
-- 조인을 하기 위해서 꼭 외래키 제약조건을 달아야 하는 것은 아니다!
...
-- ALTER USER PSH07 IDENTIFIED BY PSH070000;
