 ...
 *  
 * => 해당 테이블에 모든 컬럼에 추가하고자 하는 값을 직접 입력해서 한 행을 INSERT할 때 사용한다.
 ...
 * 
 * 주의할 점 ) NOT NULL이 달려있는 컬럼은 반드시 테이블 명 뒤에 컬럼명을 적어야 한다.
 * 예외 사항 ) NOT NULL 제약조건이 달려 있는데 기본값이 있는 경우에는 DEFAULT VALUE가 들어감
 */
 ...
 * => VALUES 대신에 서브쿼리를 작성해서 INSERT할 수 있음
 */
-- 새 테이블 하나 만들기
CREATE TABLE EMP_01(
